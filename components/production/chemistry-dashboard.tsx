...
export function ChemistryDashboard(){
  ...
  return <div className="space-y-6">
    ...
    <section className="border-b pb-3" aria-label="Contexto de Química">
      ...
      <p className="mt-2 text-xs text-muted-foreground">{view==='process'?(p?`Operación de Planta/Metalurgia disponible hasta ${date(p.dataThrough)}.`:'Ensayos de proceso de Planta/Metalurgia.'):'Muestras especiales 2016–2017 · contexto histórico; no son ensayes de sondaje ni ley representativa del plan 2026.'}</p>
    </section>
