...
export function ChemistryDashboard(){
  ...
  return <div className="space-y-6">
    ...
    <section className="grid gap-px overflow-hidden rounded-lg border bg-border sm:grid-cols-2 xl:grid-cols-4" aria-label="Química de mina">
      ...
      <Metric label="Sectores fuente" value={n(sourceSectorCount)} detail="Mina + texto original"/>
