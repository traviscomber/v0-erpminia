...
export function GeologiaPendingDecisionQueue(props:Props){
  ...
  return <div className="space-y-5">
    ...
    </section>:<div className="rounded-lg border border-dashed bg-muted/10 px-5 py-8 text-center"><p className="font-medium">Sin revisiones de ubicación activas</p><p className="mx-auto mt-2 max-w-xl text-sm text-muted-foreground">No hay casos explícitos abiertos en la cola de revisión.</p></div>}
