...
const operationalRoles = [
  'superadmin', 'admin', 'manager', 'supervisor', 'Operaciones-Supervisor', 'Sostenibilidad-Supervisor', 'HSE-Supervisor', 'Bodega-Supervisor', 'Compras-Supervisor', 'jefe_mantencion',
];

const allStandardRoles = [
  'superadmin', 'admin', 'manager', 'supervisor', 'viewer', 'jefe_mantencion', 'Operaciones-Supervisor', 'Finanzas-Supervisor', 'Bodega-Supervisor', 'Compras-Supervisor', 'Sostenibilidad-Supervisor', 'HSE-Supervisor',
];
...
const menuItems: MenuItem[] = [
  ...
  { label: 'Desempeño', href: '/dashboard/desempeno', icon: Gauge, group: 'Transversal', roles: ['superadmin', 'admin', 'manager'] },
