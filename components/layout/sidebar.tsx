...
const menuItems = [
  ...
  { label: 'Órdenes de Trabajo', href: '/dashboard/work-orders', icon: Plus, group: 'Mant. Operaciones' },
  { label: 'Bitácora de Mantenimiento', href: '/dashboard/mantenimiento/bitacora', icon: File, group: 'Mant. Operaciones' },
  { label: 'Planificación Preventiva', href: '/dashboard/mantenimiento/planificacion', icon: Calendar, group: 'Mant. Operaciones' },
  { label: 'Mantenimiento por Centro de Costo', href: '/dashboard/mantenimiento/centro-costo', icon: Building2, group: 'Mant. Operaciones' },
  { label: 'Panel Móvil Mantención', href: '/dashboard/mantenimiento/movil', icon: Smartphone, group: 'Mant. Operaciones' },
  // Mantenimiento — Equipos
  { label: 'Maquinaria y Vehículos', href: '/dashboard/maquinaria', icon: Truck, group: 'Mant. Equipos' },
  { label: 'Gestión de Neumáticos', href: '/dashboard/mantenimiento/neumaticos', icon: Boxes, group: 'Mant. Equipos' },
  { label: 'Componentes Mayores', href: '/dashboard/mantenimiento/componentes-mayores', icon: Wrench, group: 'Mant. Equipos' },
  { label: 'Disponibilidad de Equipos', href: '/dashboard/mantenimiento/disponibilidad', icon: Activity, group: 'Mant. Equipos' },
  // Mantenimiento — Recursos y Costos
  { label: 'Personal Mantención', href: '/dashboard/mantenimiento/personal', icon: Users, group: 'Mant. Recursos' },
  { label: 'Combustible', href: '/dashboard/mantenimiento/combustible', icon: Fuel, group: 'Mant. Recursos' },
  { label: 'Costo por Equipo', href: '/dashboard/mantenimiento/costos', icon: DollarSign, group: 'Mant. Recursos' },
  // Mantenimiento — Reportes
  { label: 'Dashboard Gerencial Mantención', href: '/dashboard/mantenimiento/gerencial', icon: BarChart3, group: 'Mant. Reportes' },
  { label: 'Indicadores de Mantención', href: '/dashboard/mantenimiento/indicadores', icon: BarChart3, group: 'Mant. Reportes' },
  // Mantenimiento — Documentos
  { label: 'Documentos Mantenimiento', href: '/dashboard/mantenimiento/documentos', icon: File, group: 'Mant. Documentos' },
  { label: 'Fichas Técnicas', href: '/dashboard/mantenimiento/fichas-tecnicas', icon: FileCheck, group: 'Mant. Documentos' },
...
export function Sidebar() {
  ...
  const [expandedGroups, setExpandedGroups] = useState<Record<string, boolean>>({
    ...
    Producción: true,
    Mantenimiento: true,
    'Mant. Operaciones': true,
    'Mant. Equipos': false,
    'Mant. Recursos': false,
    'Mant. Reportes': false,
    'Mant. Documentos': false,
      ...
      >
        ...
        <nav className="flex-1 px-4 py-6 overflow-y-auto">
          <div className="space-y-2">
            {['Core', 'Producción', 'Mantenimiento', 'Mant. Operaciones', 'Mant. Equipos', 'Mant. Recursos', 'Mant. Reportes', 'Mant. Documentos', 'Bodega e Inventario', 'Sostenibilidad', 'Finanzas', 'Legal', 'Inteligencia Artificial', 'Administración', 'Ayuda'].map(
              (group) => {
