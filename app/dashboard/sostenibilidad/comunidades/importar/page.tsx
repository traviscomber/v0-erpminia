...
export default function ComunidadesImportPage() {
  ...
  const downloadTemplate = () => {
    ...
    a.href = url;
    a.download = 'plantilla-comunidades.csv';
  ...
  const uploadFile = async (file: File) => {
    ...
    try {
      ...
      if (!response.ok) {
        setResult({
          success: false,
          message: 'No se pudieron importar los registros comunitarios',
      ...
      setResult({
        success: true,
        message: payload.message || 'Registros comunitarios importados correctamente',
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button asChild>
            <Link href="/dashboard/sostenibilidad/comunidades">
          ...
          <Alert>
            ...
            <AlertDescription>
              ...
              <div className="rounded bg-muted p-2 font-mono text-sm">
                FECHA | TIPO | DESCRIPCION | STAKEHOLDER | ESTADO | TIPO_STAKEHOLDER | UBICACION | CONTACTO_PERSONA | CONTACTO_EMAIL | CONTACTO_TELEFONO | IMPACTADO_POR | FECHA_SEGUIMIENTO | RESPONSABLE | OBSERVACIONES | TIPO_DOCUMENTO | PRIORIDAD
              </div>
            </AlertDescription>
          </Alert>
