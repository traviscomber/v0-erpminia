...
export default function MedioAmbienteImportPage() {
  ...
  const downloadTemplate = () => {
    ...
    a.href = url;
    a.download = 'plantilla-medio-ambiente.csv';
  ...
  const uploadFile = async (file: File) => {
    ...
    try {
      ...
      if (!response.ok) {
        setResult({
          success: false,
          message: 'No se pudo importar el registro ambiental',
      ...
      setResult({
        success: true,
        message: payload.message || 'Registros importados correctamente',
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div>
          <h1 className="text-3xl font-bold">Importar registros ambientales</h1>
          <p className="mt-2 max-w-3xl text-muted-foreground">
            Carga emisiones, residuos, agua o ruido desde Excel para mantener el seguimiento ambiental actualizado.
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <Button asChild>
            <Link href="/dashboard/sostenibilidad/medio-ambiente">
          ...
          <Alert>
            ...
            <AlertDescription>
              ...
              <div className="rounded bg-muted p-2 font-mono text-sm">
                TIPO | DESCRIPCION | VALOR | UNIDAD | CUMPLIMIENTO
              </div>
            </AlertDescription>
          </Alert>
