...
export default function BodegaPage() {
  ...
  return <div className="space-y-6">
    <PageHeader><PageHeaderContent><PageHeaderEyebrow>Abastecimiento</PageHeaderEyebrow><PageHeaderTitle>Inventario</PageHeaderTitle><PageHeaderDescription>Busca existencias, revisa stock y detecta qué necesita reposición.</PageHeaderDescription></PageHeaderContent><PageHeaderActions><Button asChild><Link href="/dashboard/compras/importar-existencias"><Upload className="h-4 w-4" />Importar existencias</Link></Button></PageHeaderActions></PageHeader>
    ...
    <section className="space-y-4">
      ...
      {isLoading ? <StatePanel tone="loading" title="Cargando inventario" description="Consultando las existencias registradas." /> : !error && positions.length === 0 ? <StatePanel tone="neutral" title="No hay productos para mostrar" description="Prueba con otros filtros o revisa si las existencias ya fueron importadas." /> : null}
