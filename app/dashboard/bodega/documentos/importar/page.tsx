...
export default function BodegaDocumentosImportarPage() {
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          <Button variant="outline" asChild>
            <Link href="/dashboard/bodega/importar-datos">Importador tabular</Link>
          </Button>
          <Button variant="outline" asChild>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <DocumentUpload module="bodega" category="documentos" onUploadSuccess={handleUploadSuccess} />
          {uploadedName ? (
