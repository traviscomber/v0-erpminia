...
export default function ComprasDocumentosImportarPage() {
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          <Button variant="outline" asChild>
            <Link href="/dashboard/compras/importar-existencias">Importador tabular</Link>
          </Button>
          <Button variant="outline" asChild>
            <Link href="/dashboard/compras/documentos">
