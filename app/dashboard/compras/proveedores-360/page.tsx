...
import { Building2, FileText, PackageSearch, ReceiptText, Search, ShieldCheck, ShoppingCart } from 'lucide-react';
      ...
      <div className="space-y-5">
        ...
        {detail && !loading && <>
          ...
          <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">{[
            ['Compras acumuladas', money.format(totals.spend), ShoppingCart],
            ['Facturado', money.format(totals.invoices), ReceiptText],
            ['Productos', detail.suppliedProducts.length, PackageSearch],
            ['Contratos', detail.contracts.length, FileText],
            ['Puntaje', detail.performance ? Number(detail.performance.performance_score || 0).toFixed(0) : '—', ShieldCheck],
