        ...
        <Card>
          ...
          <CardContent className="flex flex-wrap gap-2">
            <Button asChild variant="outline">
              <Link href="/dashboard/mantenimiento/ordenes-trabajo">Volver a órdenes</Link>
            </Button>
            <Button asChild>
              <Link href="/dashboard/mantenimiento/ordenes-trabajo/create">Crear nueva orden</Link>
            </Button>
          </CardContent>
        </Card>
      )}
