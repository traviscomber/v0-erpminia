...
import { AlertTriangle, ClipboardCheck, Gauge, RefreshCw, Wrench } from 'lucide-react';
...
export default function PreventiveHoursPage() {
  ...
  return <div className="space-y-6">
    ...
    <Card className="shadow-none"><CardContent className="p-4 text-sm"><p className="font-medium">Procedimiento estándar: evidencia pendiente</p><p className="mt-1 text-muted-foreground">Motil tiene el motor para pasos, controles y repuestos, pero hoy no existen planes estándar aprobados ni BOM técnico cargado. Define y aprueba el procedimiento antes de usarlo para enriquecer una OT.</p></CardContent></Card>
