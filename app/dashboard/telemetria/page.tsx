    ...
    <div className="space-y-6">
      <section className="flex flex-col gap-4 border-b border-border pb-6 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-3xl">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground">Operaciones · Telemetría</p>
          <h1 className="mt-1 text-3xl font-semibold tracking-tight">Monitoreo de sensores</h1>
      ...
      <Card>
        ...
        <CardContent className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          <div className="rounded-md border border-border p-4">
            ...
            <p className="mt-1 break-all font-mono text-sm font-medium">POST /api/telemetry/ingest</p>
          </div>
          <div className="rounded-md border border-border p-4">
            <p className="text-xs text-muted-foreground">Autenticación</p>
            <p className="mt-1 break-all font-mono text-sm font-medium">x-telemetry-token</p>
          </div>
          <div className="rounded-md border border-border p-4">
