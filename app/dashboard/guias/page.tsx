    ...
    <div className="space-y-8">
      ...
      <div className="mt-12 space-y-12">
        ...
        <div id="arbol" className="border-l-4 border-l-[var(--brand-verde)] py-6 pl-6">
          ...
          <ol className="space-y-4">
            <li><strong>Paso 1:</strong> Ve a Mantenimiento -&gt; Gestion de Vehiculos</li>
        ...
        <div id="reportes" className="border-l-4 border-l-[var(--brand-gold)] py-6 pl-6">
          ...
          <ol className="space-y-4">
            ...
            <li><strong>Decisiones:</strong> Usa los datos para optimizar la frecuencia de mantenimiento preventiva</li>
          </ol>
