    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 md:py-32">
        <div className="text-center space-y-6 mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Conecta producción, mantención, bodega, HSE, documentos y gerencia en un flujo trazable
            desde terreno hasta dirección.
          </p>
          <div className="flex gap-4 justify-center pt-8">
            <Link href="/auth/login">
              <Button
                size="lg"
                className="gap-2 bg-[var(--brand-cobre)] hover:bg-[var(--brand-cobre)]/90 text-base px-8"
              >
                Solicitar Demo
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 border-t border-border">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Sensores dispersos. Órdenes de trabajo perdidas. Repuestos no localizados. HSE
            desconectado. Auditoría imposible.
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 border-t border-border">
        ...
        <p className="text-center text-muted-foreground max-w-4xl mx-auto mb-8">
          Evento operacional → Alerta → Orden de trabajo → Repuestos → HSE → Evidencia → Auditoría
          → KPIs
        </p>
      ...
      <section className="max-w-7xl mx-auto px-4 py-20 border-t border-border text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
          Conecta producción, mantención, bodega, HSE, documentos y gerencia en una sola plataforma
          trazable.
        </p>
        <Link href="/auth/login">
          <Button
