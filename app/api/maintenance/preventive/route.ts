      ...
      const mockSchedules: PreventiveScheduleItem[] = [
        {
          ...
          location: 'Rajo Norte',
          criticality: 'Alta',
          taskName: 'Revisión preventiva',
          description: 'Inspección de sistemas hidráulicos y motores',
          frequencyDays: 30,
          frequencyHours: null,
        ...
        },
        {
          ...
          criticality: 'Crítica',
          taskName: 'Mantenimiento bimensual',
          description: 'Revisión de sistemas neumáticos y eléctricos',
          frequencyDays: 60,
          frequencyHours: null,
          lastExecutedDate: new Date(now.getTime() - 70 * 86400000).toISOString().split('T')[0],
          nextScheduledDate: new Date(now.getTime() - 10 * 86400000).toISOString().split('T')[0],
