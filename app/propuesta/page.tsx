...
export default function ProposalPage() {
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="mx-auto mb-6 flex max-w-4xl gap-4">
      ...
      <div className="mx-auto max-w-4xl bg-white p-12 print:p-0">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 text-gray-700">
            ...
            enterprise para gestión operacional en empresas mineras chilenas. El proyecto incluye 5
            módulos operacionales, autenticación avanzada, compliance regulatorio (SERNAGEOMIN), y 1
            año de soporte SaaS.
          </p>
        ...
        <section className="mb-8 page-break">
          ...
          <div className="mb-6">
            <h3 className="mb-3 text-lg font-semibold text-foreground">
              Fase 2: SaaS - Soporte y Operación (Año 1)
            </h3>
            <table className="w-full text-sm">
              <tbody className="divide-y">
                <tr>
          ...
          <div className="rounded-lg border border-[var(--secondary)]/30 bg-[var(--secondary)]/5 p-4">
            <p className="mb-1 font-semibold text-gray-900">Inversión Total Año 1 (Desarrollo + SaaS)</p>
        ...
        <section className="mb-8 page-break">
          ...
          <ul className="space-y-2 text-gray-700">
            <li className="flex gap-3">
              <span className="font-bold text-[var(--brand-verde)]">✓</span>
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-bold text-gray-900">Proyección Financiera</h2>
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y">
              <tr>
                <td className="px-2 py-2">Meses 1-7 (Desarrollo)</td>
                <td className="px-2 py-2 text-right">CLP 29.75M</td>
                <td className="px-2 py-2 text-right">CLP 29.75M</td>
                <td className="px-2 py-2 text-right">0%</td>
              </tr>
              <tr>
                <td className="px-2 py-2">Meses 8-12 (SaaS)</td>
                <td className="px-2 py-2 text-right">CLP 5M</td>
                <td className="px-2 py-2 text-right">CLP 1.8M</td>
                <td className="px-2 py-2 text-right">64%</td>
              </tr>
              <tr className="bg-muted/5 font-semibold">
                <td className="px-2 py-2">Año 1 Completo</td>
                <td className="px-2 py-2 text-right">CLP 34.75M</td>
                <td className="px-2 py-2 text-right">CLP 31.55M</td>
                <td className="px-2 py-2 text-right">9%</td>
              </tr>
              <tr>
                <td className="px-2 py-2">Año 2 (SaaS)</td>
                <td className="px-2 py-2 text-right">CLP 12M</td>
                <td className="px-2 py-2 text-right">CLP 3.8M</td>
                <td className="px-2 py-2 text-right">68%</td>
              </tr>
              <tr>
                <td className="px-2 py-2">Año 3 (SaaS)</td>
                <td className="px-2 py-2 text-right">CLP 12M</td>
                <td className="px-2 py-2 text-right">CLP 4.2M</td>
                <td className="px-2 py-2 text-right">65%</td>
              </tr>
            </tbody>
          </table>
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-bold text-gray-900">Términos y Condiciones</h2>
          <ul className="space-y-2 text-sm text-gray-700">
            <li>
              <strong>Validez:</strong> Esta propuesta es válida hasta el 23 de Mayo de 2026
            </li>
            <li>
              <strong>Moneda:</strong> Todos los valores en CLP (Pesos Chilenos)
            </li>
            <li>
              <strong>IVA:</strong> No incluido en los precios base (se añade 19%)
            </li>
            <li>
              <strong>Garantía:</strong> 1 año de soporte incluido post-launch
            </li>
            <li>
              <strong>SLA:</strong> 99.9% de disponibilidad comprometida
            </li>
            <li>
              <strong>Propiedad Intelectual:</strong> Código y documentación son propiedad del cliente
            </li>
            <li>
              <strong>Inicio:</strong> Sujeto a firma de contrato y confirmación de presupuesto
            </li>
          </ul>
        </section>
