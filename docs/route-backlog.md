...
| `/dashboard/sostenibilidad/compliance/importar` | Live verified authenticated render on July 6, 2026; source rechecked on July 7, 2026 and import validation/result copy is normalized | Medium | Validate the import experience after deploy and ensure templates and upload states remain clear. |
