...
| `/dashboard/sostenibilidad/prevencion-riesgos/acciones-correctivas` | Live verified authenticated render on July 6, 2026; source rechecked on July 7, 2026 and cross-module cards now route directly here instead of the generic sustainability dashboard | Low | Keep corrective-action tracking aligned with non-conformities and prevention reporting. |
