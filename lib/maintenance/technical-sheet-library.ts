...
const TECHNICAL_SHEET_LIBRARY: TechnicalSheetReference[] = [
  ...
  },
  {
    ...
    model: '928G',
    family: 'Cargadores Frontales',
    aliases: ['928g', '928 g', 'cat 928g', 'cat 928 g', 'caterpillar 928g', 'caterpillar 928 g', 'ceterpillar 928g'],
  ...
  },
  {
    ...
    keySpecs: [
      { label: 'Aplicacion', value: 'Carga y acarreo' },
      { label: 'Enfoque', value: 'Productividad y eficiencia' },
    ...
    components: [
      {
        ...
        level: 1,
        criticality: 'alta',
        description: 'Sistema de traccion y conversion de potencia.',
        faults: [
          {
            code: 'PWR-SLIP',
            name: 'Patinamiento o baja respuesta',
            severity: 'media',
            symptom: 'Menor empuje o ciclos mas lentos',
            cause: 'Aceite, embrague o desgaste interno',
            effect: 'Menor productividad',
            recommendedAction: 'Revisar aceite, filtros y diagnostico del tren motriz',
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    model: 'Onram 1000/3',
    family: 'Equipos de Sondaje',
    aliases: ['onram 1000/3', 'onram 1000', 'hagby onram 1000/3', 'hagby onram 1000', '1000/3', 'sonda onram 1000/3', 'sonda onram 1000 3'],
  ...
  },
  {
    ...
    model: '225 NXT',
    family: 'Excavadoras y Retroexcavadoras',
    aliases: ['225', 'jcb 225', 'jcb 225 nxt', '225 nxt', 'jcb 225lc', '225lc', 'jcb 225 2011', 'minicargador jcb 225', 'mini cargador jcb 225', 'jcb minicargador', 'minicargador jcb'],
  ...
  },
  {
    ...
    model: 'XAMS',
    family: 'Compresores',
    aliases: ['xams', 'xams 850', 'xams 1150', 'atlas copco xams', 'xams 850e', 'xams 550e'],
    sourceUrl: 'https://www.atlascopco.com/en-us/compressors/products/air-compressor',
    sourceLabel: 'Atlas Copco XAMS',
    summary: 'Familia de compresores portatiles de alta eficiencia para suministro de aire en faena.',
    keySpecs: [
      { label: 'Aplicacion', value: 'Suministro de aire' },
      { label: 'Enfoque', value: 'Alta eficiencia y rango de presion' },
      { label: 'Tipo', value: 'Portable compressor' },
    ],
    components: [
      {
        code: 'ENG',
        name: 'Motor y tren de potencia',
        level: 1,
        criticality: 'alta',
        description: 'Sistema de propulsion y entrega de energia del compresor.',
        faults: [
          {
            code: 'ENG-POWER',
            name: 'Baja entrega de potencia',
            severity: 'media',
            symptom: 'Menor caudal o presion',
            cause: 'Filtro, combustible o desgaste mecánico',
            effect: 'Menor disponibilidad de aire',
            recommendedAction: 'Revisar motor, filtros y diagnostico',
          },
        ],
      },
    ],
  },
  {
    ...
    keySpecs: [
      { label: 'Aplicacion', value: 'Suministro de aire' },
      { label: 'Enfoque', value: 'Portabilidad y rendimiento' },
      { label: 'Tipo', value: 'Portable air compressor' },
    ],
    components: [
      {
  ...
  },
  {
    ...
    model: 'Simba S7',
    family: 'Equipos de Perforacion',
    aliases: ['simba s7', 'simba s7d', 's7d', 'simba', 'jumbo simba', 'simba h1253', 'simba h-1253', 'jumbo atlas copco simba s7d', 'jumbo atlas copco simba h1253', 'jumbo atlas copco simba h-1253'],
  ...
  },
  {
    ...
    model: 'Volksbus',
    family: 'Buses',
    aliases: ['trendy', 'volksbus', 'vw trendy', 'bus volkswagen trendy', 'volkswagen trendy', 'bus trendy'],
  ...
  },
  {
    ...
    model: 'Auman 3938',
    family: 'Camiones',
    aliases: ['auman 3938', 'foton auman 3938', 'auman', 'foton auman', 'foton auman rjrv 73', 'auman rjrv 73', 'auman tolva 6x4', 'tolva 6x4'],
  ...
  },
  {
    ...
    model: 'P600',
    family: 'Compresores',
    aliases: ['p600', 'p-600', 'doosan p600', 'doosan p-600', 'doosan n1', 'doosan n 1', 'doosan ni 1', 'compresor doosan 600', 'compresor ir doosan 600', 'compresor doosan p600', 'compresor doosan p-600', 'compresor doosan n1', 'compresor doosan n 1', 'compresor doosan ni 1'],
  ...
  },
  {
    ...
    model: 'L120F',
    family: 'Cargadores Frontales',
    aliases: ['l120f', 'volvo l120f', 'cargador volvo l120f', 'cargador volvo l-120-f'],
  ...
  },
  {
    ...
    model: 'XC928',
    family: 'Cargadores Frontales',
    aliases: ['xc928', 'xc928-ev', 'cargador chino xc928', 'xcmg xc928', 'xc-928', 'cargador xc-928'],
  ...
  },
  {
    ...
    model: '150 KVA',
    family: 'Grupos Generadores',
    aliases: ['tdb', 'tdb 150', 'tdb 150 kva', 'generador tdb 150 kva'],
    sourceUrl: 'https://target-generators.com/product/robust-150kva-standby-generator-baudouin-engine-target-power-tb150/',
    sourceLabel: 'TDB 150 KVA',
    summary: 'Grupo generador identificado en la base local como TDB 150 KVA para respaldo electrico.',
    keySpecs: [
      { label: 'Aplicacion', value: 'Respaldo electrico' },
      { label: 'Tipo', value: 'Generator set' },
      { label: 'Enfoque', value: 'Continuidad y respaldo' },
