...
test('global navigation uses the role-aware home instead of parallel personal portals', async () => {
...
test('role-aware home keeps operational personalization after sidebar simplification', async () => {
