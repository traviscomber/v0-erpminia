...
begin
  ...
  v_ended_at := v_started_at + make_interval(secs => (p_hours * 3600)::double precision);
  ...
  insert into public.work_order_labor_entries(
    ...
    started_at,ended_at,hourly_cost,notes,created_by
  ) values (
    p_organization_id,p_work_order_id,v_asset_id,p_technician_id,p_technician_name,
    v_started_at,v_ended_at,p_hourly_cost,p_notes,p_actor_id
  )
  ...
  insert into public.work_order_events(
    ...
    p_organization_id,p_work_order_id,v_asset_id,'labor_added',v_started_at,p_actor_id,
